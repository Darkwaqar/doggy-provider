...
const ProviderSetup = ({ navigation }) => {
  ...
  useEffect(() => {
    axios
      .get("https://doggywawky.com/api/dog/all", {
  ...
  useEffect(() => {
    axios
      .get("https://doggywawky.com/api/me", {
        headers: { Authorization: `Bearer ${acces_token}` },
      })
      .then(async (response) => {
  ...
  const data = {
    ...
    owners_expect_when_boarding_at_your_home: ["smooking", "age05"],
  ...
  const Save = () => {
    axios
      .post("https://doggywawky.com/api/dashboard/store", data, {
        headers: { Authorization: `Bearer ${acces_token}` },
      })
      .then(async (response) => {
  ...
  const renderItem = ({ item }) => (
    <DogList
      name={item.pet_name}
      image={item.dog_profile_image ? item.dog_profile_image : product}
    />
  );
        ...
        <SafeAreaView>
          <ScrollView>
            <View style={{ marginBottom: 100, marginTop: 50 }}>
              ...
              >
                {userInfo?.user_details.user_image ? (
                  <Image
                    style={styles.image}
                    source={userInfo.user_details.user_image}
                  />
                ) : (
                  <Image style={styles.image} source={DemoPic} />
                )}
                <Text
                  style={{ fontFamily: "oswald", fontSize: 20, color: "white" }}
                >
                  {userInfo?.full_name}
                </Text>
                <TouchableOpacity
              ...
              <View style={{ marginHorizontal: 5, marginVertical: 20 }}>
                ...
                <Text style={{ color: "gray" }}>
                  Add your dogs or edit their info
                </Text>
                <TouchableOpacity
                  style={styles.button}
              ...
              >
                <View>
                  <Text style={{ fontFamily: "Montserrat", fontSize: 15 }}>
                    Write headline short, descriptive and genuine.
                  </Text>
                  <TextInput
                    style={styles.formInput}
                    onChangeText={setshort_headline}
                    value={short_headline}
                  />
                </View>
                <View>
                  <Text style={{ fontFamily: "Montserrat", fontSize: 15 }}>
                ...
                <View>
                  ...
                  <TextInput
                    style={styles.formInput}
                    onChangeText={setabout_yourself}
              ...
              >
                <View style={{ alignItems: "center" }}>
                  ...
                  <View style={{ marginVertical: 10 }}>
                    ...
                    <TouchableOpacity
                      style={Smoking ? styles.buttonTrue : styles.buttonFalse}
                    ...
                    <TouchableOpacity
                      style={Age05 ? styles.buttonTrue : styles.buttonFalse}
                      onPress={() => setAge05(!Age05)}
                    >
                      <Text
                        style={
                          Age05
                    ...
                    <TouchableOpacity
                      style={Age612 ? styles.buttonTrue : styles.buttonFalse}
                      onPress={() => setAge612(!Age612)}
                    >
                      <Text
                        style={
                          Age612
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => setFurnitureAllowed(!FurnitureAllowed)}
                    >
                      <Text
                        style={
                          FurnitureAllowed
                    ...
                    <TouchableOpacity
                      style={
                        AllowedonBed ? styles.buttonTrue : styles.buttonFalse
                      }
                      onPress={() => setAllowedonBed(!AllowedonBed)}
                    >
                      <Text
                        style={
                          AllowedonBed
                    ...
                    <TouchableOpacity
                      style={Caged ? styles.buttonTrue : styles.buttonFalse}
                      onPress={() => setCaged(!Caged)}
                    >
                      <Text
                        style={
                          Caged
                  ...
                  <View style={{ marginVertical: 10 }}>
                    ...
                    <TouchableOpacity
                      style={Families ? styles.buttonTrue : styles.buttonFalse}
                      onPress={() => setFamilies(!Families)}
                    >
                      <Text
                        style={
                          Families
                    ...
                    <TouchableOpacity
                      style={
                        Puppiesunder1 ? styles.buttonTrue : styles.buttonFalse
                      }
                      onPress={() => setPuppiesunder1(!Puppiesunder1)}
                    >
                      <Text
                        style={
                          Puppiesunder1
                    ...
                    <TouchableOpacity
                      style={
                        notcrateTrained ? styles.buttonTrue : styles.buttonFalse
                      }
                      onPress={() => setnotcrateTrained(!notcrateTrained)}
                    >
                      <Text
                        style={
                          notcrateTrained
                    ...
                    <TouchableOpacity
                      style={
                        UnneuteredMale ? styles.buttonTrue : styles.buttonFalse
                      }
                      onPress={() => setUnneuteredMale(!UnneuteredMale)}
                    >
                      <Text
                        style={
                          UnneuteredMale
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => setUnneuteredFemale(!UnneuteredFemale)}
                    >
                      <Text
                        style={
                          UnneuteredFemale
                      ...
                      >
                        Unneutered female dogs
                      </Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                      style={
                        femaleinHeat ? styles.buttonTrue : styles.buttonFalse
                      }
                      onPress={() => setfemaleinHeat(!femaleinHeat)}
                    >
                      <Text
                        style={
                          femaleinHeat
