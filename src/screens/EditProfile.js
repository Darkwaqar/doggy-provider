...
const EditProfile = ({ navigation }) => {
  ...
  const Save = () => {
    axios
      .post("https://doggywawky.com/api/account-setting", _data, {
  ...
  useEffect(() => {
    axios
      .get(`https://doggywawky.com/api/states/${2}`)
      ...
      axios
        .get(`https://doggywawky.com/api/cities/${State}`)
        .then(function (response) {
  ...
  return (
    <ImageBackground style={{ flex: 1 }} source={Background} blurRadius={4}>
      ...
      >
        ...
        >
          <TouchableOpacity
            style={BasicInfo ? styles.true : styles.button}
            onPress={toggleBasicInfo}
          >
            <Text style={styles.buttontext}>Basic Info</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={PersonelInfo ? styles.true : styles.button}
            onPress={togglePersonelInfo}
          >
            <Text style={styles.buttontext}>Personel Info</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={PaymnetMethod ? styles.true : styles.button}
            onPress={togglePaymnetMethod}
          >
