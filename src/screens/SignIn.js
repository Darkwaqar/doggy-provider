...
const SignIn = ({ navigation }) => {
  ...
  function Post() {
    axios
      .post("https://doggywawky.com/api/auth/login", data)
      ...
      .catch(function (error) {
        if (userName === "" || password === "") {
          ...
          error.response.data.data.errors.email &&
            setMessage(error.response.data.data.errors.email);
      ...
      >
        <View style={styles.container}>
          ...
          <KeyboardAvoidingView behavior="height">
            <Text style={success ? { color: "green" } : { color: "red" }}>
              {Message}
            </Text>
            <TextInput
          ...
          <TouchableOpacity
            ...
            style={styles.button}
          >
            <Text style={{ color: "white", fontWeight: "bold" }}>Login In</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          <View>
            ...
            >
              <Text style={{ color: "blue", marginTop: 20, marginBottom: 150 }}>
                Forgot Password
              </Text>
            </TouchableOpacity>
          </View>
