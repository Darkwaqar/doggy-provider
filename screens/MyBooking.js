...
useEffect(()=>{
    axios.get('https://doggywawky.com/api/bookings/1',
     { 
...
<View style={{height:200,width:'100%' ,backgroundColor:'#22224a',justifyContent:'flex-end',alignItems:'center',}}>
    <Text style={{color:'white',fontSize:45,fontFamily:'oswald',marginBottom:5}}>Booking List </Text>
</View>
<View style={styles.flatList}>
    <FlatList
    data={data}
keyExtractor={(item)=>item.id}
renderItem={({item})=>(<BookingTab number={'123'} address={'Houston Texas'} date={'4-2-2022'} amount={'$400'} requested={'June'}/>)}
    />
</View>
