import { StyleSheet, Text, View,ImageBackground,TextInput,TouchableOpacity ,Image,ScrollView,Animated, Alert,SafeAreaView} from 'react-native'
...
const AddDogButton = () => {
  ...
  axios.post('https://doggywawky.com/api/dog/add', data,{ 
 ...
 return (
   <ImageBackground style={{flex:1}} source={Background} blurRadius={4} resizeMode={'cover'}>
...
<View style={{alignItems:'center',marginBottom:100,justifyContent:'space-between'}}>
<Text style={styles.heading}>Add you're dog's details</Text>

<View>
    <Text style={styles.inputHeader}>Pet Name</Text>
    <TextInput placeholder='enter pet name' style={styles.input} value={PetName} onChangeText={setPetName}/>
</View>


<View>
    <Text style={styles.inputHeader}>Description</Text>
    <TextInput placeholder='enter your dogs description' style={styles.input} value={Description} onChangeText={setDescription}/>
</View>
...
<View>
    ...
    <TextInput placeholder='enter pet weight' style={styles.input} value={Weight} onChangeText={setWeight} />
</View>

<View>
    <Text style={styles.inputHeader}>Breed</Text>
    <TextInput placeholder='enter you pet`s breed' style={styles.input} value={Breed} onChangeText={setBreed}/>
</View>

<View>
    <Text style={styles.inputHeader}>Year of birth</Text>
    <TextInput placeholder='enter you`re dogs birth year' style={styles.input} value={BirthYear} onChangeText={setBirthYear}/>
</View>


<View>
    <Text style={styles.inputHeader}>Month of birth</Text>
    <TextInput placeholder='enter you`re dogs birth month' style={styles.input} value={BirthMonth} onChangeText={setBirthMonth}/>
</View>
...
<View style={{alignItems:'center'}}>
    <Text style={styles.inputHeader}>Add you dogs profile picture</Text>
    {_image && <Image source={{ uri: _image }} style={{ width: 100, height: 100 ,marginLeft:10,borderWidth:2,marginVertical:10}} />}
<TouchableOpacity style={styles.button} onPress={pickImage}>
      ...
      <TouchableOpacity onPress={AddDogButton} style={{
